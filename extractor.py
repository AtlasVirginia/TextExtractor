...
BrowseButton = Button( root, text="Find File Path", command=x.OpenFile )
BrowseButton.grid( row=2, column=2 )

BrowseButton2 = Button( root, text="Extract Text From Pdf ", command=x.get_pdf_name)
BrowseButton2.grid( row=3, column=2 )


ReadButton = Button( root, text="Extract Text From Image", command=x.readfromimage)
ReadButton.grid( row=5, column=2 )
ReadButton2 = Button( root, text="Extract Text From docx", command=x.docx_reader)
